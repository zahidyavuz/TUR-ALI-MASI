    ...
    def handle(self, *args, **kwargs):
        ...
        TOUR_DATA = [
            ...
            },
            {
                ...
                'image_main': 'https://images.unsplash.com/photo-1545638290-7c26fa323f66?fit=crop&w=1200&q=80',
                ...
                'description': "Ayasofya'dan Sultanahmet'e, Topkapı Sarayı'ndan Yerebatan Sarnıcı'na unutulmaz bir İstanbul rüyası sizi bekliyor.",
                'included': ['Tüm Konaklamalar', 'Ulaşım', 'Rehberlik'],
                'excluded': ['Öğle Yemekleri', 'Vize Ücretleri'],
                'category': 'culture, history, city',
                'filmed_in': 'Muhteşem Yüzyıl',
            }
        ]
