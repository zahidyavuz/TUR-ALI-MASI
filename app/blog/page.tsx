...
export const metadata = {
    title: 'Seyahat Blogu & Rehberler | Melih Tours',
    description: "Dünyanın dört bir yanından ipuçları, rehberler ve Melih Tours uzman kadrosundan eşsiz seyahat anıları.",
};
            ...
            <div className="bg-[#0f172a] text-white py-20 px-6 sm:px-12 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    <Link href="/" className="text-2xl font-extrabold text-white tracking-tighter mb-8 inline-block">
                        melih<span className="text-blue-400">tours™</span>
