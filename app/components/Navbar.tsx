      ...
      <nav className="w-full bg-white dark:bg-slate-900 py-3 px-4 md:py-5 md:px-8 flex justify-between items-center sticky top-0 z-[99999] border-b border-gray-100 dark:border-slate-800 shadow-sm md:shadow-none transition-colors duration-500">
        <div className="flex items-center gap-6">
          ...
          <div className="hidden lg:flex items-center gap-2 ml-8">
            ...
            <Link
              href="/transfer"
              className="group flex items-center gap-3 px-6 py-3 rounded-2xl text-[17px] font-black text-slate-800 dark:text-white hover:bg-teal-50 dark:hover:bg-teal-500/10 hover:text-teal-600 dark:hover:text-teal-400 transition-all duration-300 relative overflow-hidden whitespace-nowrap"
            >
              <span className="text-2xl group-hover:scale-125 transition-transform duration-300">🚐</span>
            ...
            <div className="hidden xl:flex items-center gap-3 pr-6 border-r border-gray-100 dark:border-slate-800">
              <a href="#" className="bg-black hover:bg-slate-800 text-white rounded-xl px-4 py-2 flex items-center gap-3 transition-all active:scale-95 shadow-lg">
                ...
                <div className="flex flex-col leading-none text-white">
                  <span className="text-[8px] uppercase font-bold opacity-60">Download on the</span>
                  <span className="text-[12px] font-black">App Store</span>
                </div>
              </a>
              <a href="#" className="bg-black hover:bg-slate-800 text-white rounded-xl px-4 py-2 flex items-center gap-3 transition-all active:scale-95 shadow-lg">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 01-.61-.92V2.734a1 1 0 01.609-.92zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-1.404l2.937 1.697c.552.32.552 1.12 0 1.44l-2.937 1.697-2.635-2.637 2.635-2.197zM5.864 2.658L16.8 8.99l-2.302 2.302-8.635-8.635z"/></svg>
                <div className="flex flex-col leading-none text-white">
                  <span className="text-[8px] uppercase font-bold opacity-60">GET IT ON</span>
                  <span className="text-[12px] font-black">Google Play</span>
                </div>
              </a>
            </div>
