...
export default function GeofenceTrigger({ className = '', compact }: GeofenceTriggerProps) {
  ...
  if (compact) {
    return (
      ...
      >
        ...
        <span>{isLoading ? 'Konum alınıyor...' : 'Yakınımdaki turlar'}</span>
      </button>
    );
  }
  ...
  return (
    <div className={className}>
      ...
      >
        <span aria-hidden>📍</span>
        {isLoading ? 'Konum alınıyor...' : 'Yakınımdaki turlar'}
      </button>
      {error && (
