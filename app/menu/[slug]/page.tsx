...
export default function MenuDetailPage() {
    ...
    return (
        <main className="min-h-screen font-sans text-slate-900 pb-20 bg-gradient-to-br from-[#fdf5f2] via-[#fffbf9] to-[#f9f1ee]">
            <Navbar />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 flex flex-col lg:flex-row gap-8 relative items-start">
                ...
                <div className="w-full lg:w-2/3">
                    {/* Gallery Section */}
                    <div className="flex flex-col md:flex-row gap-4 h-[400px] md:h-[500px] rounded-[32px] overflow-hidden shadow-2xl mb-8">
                        <div className="w-full md:w-2/3 h-full relative group cursor-pointer">
                            ...
                            <div className="absolute top-6 right-6 z-20">
                                <FavoriteButton tourId={menu.id} className="p-3 rounded-full !bg-white/90 hover:!bg-red-50 hover:!text-red-500 shadow-xl" />
                            </div>
                            ...
                            <div className="absolute bottom-6 left-6 text-white">
                                ...
                                <div className="bg-white/90 text-orange-800 text-[10px] font-black px-3 py-1.5 rounded-full uppercase tracking-widest inline-flex items-center gap-1.5 mb-3 ml-2 shadow-lg backdrop-blur-sm border border-white/50">
                                    ✨ Mistik & Otantik
                                </div>
                        ...
                        <div className="hidden md:flex w-1/3 flex-col gap-4">
                            ...
                            <div className="h-1/2 rounded-[24px] overflow-hidden relative group cursor-pointer">
                                ...
                                <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors flex items-center justify-center">
                                    <span className="bg-white/90 backdrop-blur-sm text-slate-800 font-bold px-4 py-2 rounded-xl text-sm shadow-xl">+8 Görsel Seç</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-[40px] p-8 md:p-10 shadow-xl border border-gray-100 mb-12 relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-8 opacity-5">
                            <span className="text-9xl">🍽️</span>
                        </div>
                        <h2 className="text-2xl md:text-3xl font-black mb-8 text-slate-800 flex items-center gap-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="space-y-4">
                                <div className="flex items-center gap-3 mb-2">
                                    <span className="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center text-xl shadow-sm">🥗</span>
                                    <h4 className="font-black text-slate-700 uppercase text-xs tracking-widest">Başlangıçlar</h4>
                                </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3 mb-2">
                                    <span className="w-10 h-10 rounded-xl bg-red-50 flex items-center justify-center text-xl shadow-sm">🥩</span>
                                    <h4 className="font-black text-slate-700 uppercase text-xs tracking-widest">Ana Yemek</h4>
                                </div>
                                <ul className="space-y-3">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3 mb-2">
                                    <span className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-xl shadow-sm">🍰</span>
                                    <h4 className="font-black text-slate-700 uppercase text-xs tracking-widest">Tatlı & İçecek</h4>
                                </div>
                                <ul className="space-y-3">
                    ...
                    <div className="bg-white/80 backdrop-blur-xl rounded-[40px] p-8 md:p-10 shadow-2xl border border-orange-100 mb-12">
                        <h2 className="text-2xl md:text-3xl font-black mb-8 text-orange-800 flex items-center gap-3">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                <div key={idx} className="flex flex-col gap-2 p-4 rounded-2xl bg-white/50 border border-white/60">
                                    <div className="text-2xl">{detail.icon}</div>
                                    <div className="flex flex-col">
                                        <span className="text-[10px] font-black text-gray-400 uppercase">{detail.label}</span>
                                        <span className="text-sm font-extrabold text-slate-800">{detail.value}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="mb-12">
                        <h3 className="text-2xl md:text-3xl font-black mb-6 text-orange-900">Gerçek Bir Kapadokya Ritüeli...</h3>
                        <p className="text-gray-600 leading-relaxed font-medium text-lg italic mb-6">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 mb-12 bg-white rounded-[32px] p-8 shadow-sm border border-gray-100">
                        <div className="flex-1">
                            <h4 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2 text-green-600">✓ Menü İçeriği</h4>
                            <ul className="space-y-3">
                        ...
                        <div className="flex-1">
                            <h4 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2 text-red-600">✕ Dahil Olmayanlar</h4>
                            <ul className="space-y-3">
                ...
                <div className="w-full lg:w-1/3 z-10">
                    <div className={`bg-white rounded-[32px] p-6 shadow-2xl border border-gray-100 sticky top-24 transition-all duration-300 ${isSticky ? 'shadow-blue-900/10' : ''}`}>
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                {menu.originalPrice && (
                                    <p className="text-gray-400 text-sm font-bold line-through">{formatPrice(menu.originalPrice)}</p>
                                )}
                                <h3 className="text-3xl font-black text-slate-800">{formatPrice(isVip ? menu.price * 0.95 : menu.price)} <span className="text-sm font-medium text-gray-500 tracking-normal">/kişi</span></h3>
                        ...
                        <div className="bg-orange-50/80 border border-orange-200 rounded-2xl p-3 mb-6 flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-orange-800 font-bold text-sm">Hemen Ayır!</p>
                                <p className="text-orange-600 text-[11px] font-semibold">Bu menü için bu akşam sadece 3 masa boş kaldı!</p>
                            </div>
                        </div>

                        <div className="space-y-4 mb-6">
                            <div className="flex gap-2">
                                <div className="flex-1 border border-gray-200 rounded-2xl p-3 bg-slate-50 relative">
                                    <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest block mb-1">Tarih Seçin</label>
                                    <input 
                                        type="date" 
                                        className="w-full bg-transparent font-bold text-slate-800 outline-none text-xs cursor-pointer"
                                        onChange={(e) => setSelectedDate(e.target.value)}
                                    />
                                </div>
                                <div className="flex-1 border border-gray-200 rounded-2xl p-3 bg-slate-50 relative">
                                    <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest block mb-1">Servis Saati</label>
                                    <select 
                                        className="w-full bg-transparent font-bold text-slate-800 outline-none text-xs appearance-none cursor-pointer"
                                        value={selectedTime}
                            ...
                            <div className="border border-gray-200 rounded-2xl p-4 bg-slate-50 flex justify-between items-center">
                                <div>
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest block">Kişi Sayısı</label>
                                    <span className="text-[10px] font-bold text-orange-500">(Masa Kapasitesi)</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <button onClick={() => setGuests(Math.max(1, guests - 1))} className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center font-bold text-gray-600 hover:text-orange-600 hover:border-orange-300 transition">-</button>
                                    <span className="font-extrabold text-slate-800 w-4 text-center">{guests}</span>
                                    <button onClick={() => setGuests(Math.min(menu.maxCapacity, guests + 1))} className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center font-bold text-gray-600 hover:text-orange-600 hover:border-orange-300 transition" disabled={guests >= menu.maxCapacity}>+</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="pt-4 border-t border-gray-100 mb-6">
                            <div className="flex justify-between items-center">
                                <span className="font-black text-slate-800 text-lg">Toplam Tutar</span>
                                <span className="text-2xl font-black text-[#008cb3] tracking-tighter">{formatPrice(totalPriceAmount)}</span>
                            </div>
                            <p className="text-[10px] text-gray-400 font-bold mt-2 italic text-center">İçecekler ve ekstra servisler restoranda ödenir.</p>
                        </div>
                            ...
                            <div className="space-y-3">
                                {EXTRAS.map((extra) => (
                                    <div 
                                        ...
                                        className={`group relative p-3 rounded-2xl border-2 transition-all duration-300 cursor-pointer ${selectedExtras.includes(extra.id) ? 'bg-orange-50 border-orange-200 shadow-md ring-1 ring-orange-200' : 'bg-slate-50 border-gray-100 hover:border-orange-200'}`}
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-xl shadow-sm border border-gray-100 shrink-0">
                                                {extra.icon}
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                <div className="flex justify-between items-start">
                                                    <h5 className="font-black text-[12px] text-slate-800 leading-tight truncate">{extra.name}</h5>
                                                    <span className="text-[11px] font-black text-orange-600">+{formatPrice(extra.price)}</span>
                                                </div>
                                                <p className="text-[10px] text-gray-500 font-bold truncate">{extra.desc}</p>
                                            </div>
                                            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${selectedExtras.includes(extra.id) ? 'bg-orange-500 border-orange-500 scale-110' : 'bg-white border-gray-300 group-hover:border-orange-300'}`}>
                        ...
                        <div className="mt-8 bg-slate-900 text-white rounded-[24px] p-6 shadow-2xl relative overflow-hidden">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <p className="text-[9px] text-gray-400 font-black uppercase tracking-widest">Restoran</p>
                                    <p className="font-bold text-xs">{menu.restaurantName}</p>
                                </div>
                                <div>
                                    <p className="text-[9px] text-gray-400 font-black uppercase tracking-widest">İletişim</p>
                                    <p className="font-bold text-xs">+90 384 --- -- --</p>
                                </div>
                                <div>
                                    <p className="text-[9px] text-gray-400 font-black uppercase tracking-widest">Adres</p>
